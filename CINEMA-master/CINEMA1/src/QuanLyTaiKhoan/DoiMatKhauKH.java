...
public class DoiMatKhauKH {
    ...
    private void myGUI(){
       ...
       lblClose = new JLabel("x");
        ...
        txtEmail.setText(Auth.KH.getEmailKH());
    ...
    private void doiMatKhau() {
        ...
        if(!email.equals(Auth.KH.getEmailKH())) {
            MsgBox.alert(null, "Sai tên đăng nhập!");
        }
        else if(!matKhau.equals(Auth.KH.getMatKhau())) {
    ...
    public static void main(String[] args) {
        try {
            ...
            java.util.logging.Logger.getLogger(DoiMatKhauKH.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
